    ...
    byte[] readCodewords() {
        ...
        while (y < height) {
            ...
            for (int x = 0; x < width; x++) {
                int i2 = bitnrRow[x];
                bit = i2;
                if (i2 >= 0 && this.bitMatrix.get(x, y)) {
                    int i3 = bit / 6;
                    result[i3] = (byte) (result[i3] | ((byte) (1 << (5 - (bit % 6)))));
                }
            }
            y++;
            i = bit;
