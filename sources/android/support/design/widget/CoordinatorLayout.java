...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    */
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int widthUsed2 = getSuggestedMinimumWidth();
        ...
        int widthUsed3 = widthUsed2;
        int widthUsed4 = 0;
        while (true) {
            int widthUsed5 = widthUsed4;
            if (widthUsed5 < childCount2) {
                View child = this.mDependencySortedChildren.get(widthUsed5);
                if (child.getVisibility() == 8) {
                    ...
                    if (lp.keyline < 0 || widthMode == 0) {
                        ...
                        i = widthUsed5;
                        int i2 = lp.gravity;
                        int keylineGravity = GravityCompat.getAbsoluteGravity(resolveKeylineGravity(i2), layoutDirection) & 7;
                        heightUsed = heightUsed3;
                    ...
                    if (!applyInsets || ViewCompat.getFitsSystemWindows(child)) {
                        ...
                        childHeightMeasureSpec = View.MeasureSpec.makeMeasureSpec(childWidthMeasureSpec3, heightMode2);
                        childWidthMeasureSpec = childWidthMeasureSpec2;
                    }
                    Behavior b = lp.getBehavior();
                    if (b == null) {
                        widthUsed = widthUsed3;
                        heightMode = heightMode2;
                        ...
                        heightUsed2 = heightUsed;
                        childState2 = childState;
                        int heightUsed4 = childWidthMeasureSpec;
                        widthUsed = widthUsed3;
                        int widthUsed6 = keylineWidthUsed;
                        childCount = childCount2;
                        int childCount3 = childHeightMeasureSpec;
                        heightMode = heightMode2;
                        if (!b.onMeasureChild(this, child, heightUsed4, widthUsed6, childCount3, 0)) {
                        }
                        int widthUsed7 = Math.max(widthUsed, widthPadding + child.getMeasuredWidth() + lp.leftMargin + lp.rightMargin);
                        int widthUsed8 = child.getMeasuredHeight();
                        int heightUsed5 = Math.max(heightUsed2, heightPadding + widthUsed8 + lp.topMargin + lp.bottomMargin);
                        int heightUsed6 = child.getMeasuredState();
                        widthUsed3 = widthUsed7;
                        childState3 = View.combineMeasuredStates(childState2, heightUsed6);
                        heightUsed3 = heightUsed5;
                    }
                    onMeasureChild(child, childWidthMeasureSpec, keylineWidthUsed, childHeightMeasureSpec, 0);
                    int widthUsed72 = Math.max(widthUsed, widthPadding + child.getMeasuredWidth() + lp.leftMargin + lp.rightMargin);
                    int widthUsed82 = child.getMeasuredHeight();
                    int heightUsed52 = Math.max(heightUsed2, heightPadding + widthUsed82 + lp.topMargin + lp.bottomMargin);
                    int heightUsed62 = child.getMeasuredState();
                    widthUsed3 = widthUsed72;
                    childState3 = View.combineMeasuredStates(childState2, heightUsed62);
                    heightUsed3 = heightUsed52;
                }
                widthUsed4 = i + 1;
                childCount2 = childCount;
                heightMode2 = heightMode;
            } else {
                int width = View.resolveSizeAndState(widthUsed3, widthMeasureSpec, (-16777216) & childState3);
                int height = View.resolveSizeAndState(heightUsed3, heightMeasureSpec, childState3 << 16);
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    final void onChildViewsChanged(int r19) {
        /*
