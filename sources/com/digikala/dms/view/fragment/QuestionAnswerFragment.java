...
public class QuestionAnswerFragment extends Fragment {
    ...
    private static final String TAG_REQUEST = QuestionAnswerFragment.class.getSimpleName();
    private String flag;
    ...
    public static QuestionAnswerFragment newInstance(String flag) {
    ...
    private void setupViews() {
        this.recyclerView = (RecyclerView) this.view.findViewById(R.id.rv_question_answer);
