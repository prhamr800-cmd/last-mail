...
final class zzek implements Runnable {
    ...
    zzek(zzdz zzdzVar, AtomicReference atomicReference, String str, String str2, String str3, zzi zziVar) {
        this.zzasv = zzdzVar;
        ...
        synchronized (this.zzasw) {
            ...
            if (zzahVar == null) {
                ...
                if (TextUtils.isEmpty(this.zzaqy)) {
                    this.zzasw.set(zzahVar.zza(this.zzaeh, this.zzaeo, this.zzaqv));
                } else {
                    this.zzasw.set(zzahVar.zze(this.zzaqy, this.zzaeh, this.zzaeo));
                }
                this.zzasv.zzcy();
            }
        }
