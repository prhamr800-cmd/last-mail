...
final class zzsy extends zzsx<Long> {
    zzsy(zztd zztdVar, String str, Long l) {
        super(zztdVar, str, l, null);
    }
    ...
    public final Long zzs(Object obj) {
        ...
        StringBuilder sb = new StringBuilder(String.valueOf(strZztr).length() + 25 + String.valueOf(strValueOf).length());
