...
public class Fabric {
    ...
    public static class Builder {
        ...
        public Fabric build() {
            ...
            Map<Class<? extends Kit>, Kit> kitMap2 = kitMap;
            IdManager idManager = new IdManager(this.context, this.appIdentifier, this.appInstallIdentifier, kitMap2.values());
            return new Fabric(this.context, kitMap2, this.threadPoolExecutor, this.handler, this.logger, this.debuggable, this.initializationCallback, idManager);
        }
    }
    ...
    void initializeKits(Context context) {
        ...
        for (Kit kit : kits) {
            ...
            kit.initialize();
            if (initInfo != null) {
                initInfo.append(kit.getIdentifier());
                initInfo.append(" [Version: ");
                initInfo.append(kit.getVersion());
                initInfo.append("]\n");
            }
        }
        if (initInfo != null) {
