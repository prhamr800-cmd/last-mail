...
.method public intercept(Lokhttp3/Interceptor$Chain;)Lokhttp3/Response;
    ...
    .line 118
    .end local v0    # "priorResponse":Lokhttp3/Response;
    .local v14, "priorResponse":Lokhttp3/Response;
    ...
    :try_start_39
    invoke-virtual {v2, v13, v12, v11, v11}, Lokhttp3/internal/http/RealInterceptorChain;->proceed(Lokhttp3/Request;Lokhttp3/internal/connection/StreamAllocation;Lokhttp3/internal/http/HttpCodec;Lokhttp3/internal/connection/RealConnection;)Lokhttp3/Response;

    move-result-object v0
    :try_end_3d
    .catch Lokhttp3/internal/connection/RouteException; {:try_start_39 .. :try_end_3d} :catch_125
    .catch Ljava/io/IOException; {:try_start_39 .. :try_end_3d} :catch_10d
    .catchall {:try_start_39 .. :try_end_3d} :catchall_10b
    ...
    .line 144
    invoke-virtual {v12, v11}, Lokhttp3/internal/connection/StreamAllocation;->streamFailed(Ljava/io/IOException;)V
    ...
    .line 181
    new-instance v17, Lokhttp3/internal/connection/StreamAllocation;
    ...
    .restart local v3    # "streamAllocation":Lokhttp3/internal/connection/StreamAllocation;
    iput-object v3, v1, Lokhttp3/internal/http/RetryAndFollowUpInterceptor;->streamAllocation:Lokhttp3/internal/connection/StreamAllocation;
    ...
    .end local v8    # "followUpCount":I
    .restart local v11    # "followUpCount":I
    ...
    .line 191
    .end local v14    # "priorResponse":Lokhttp3/Response;
    ...
    .line 185
    .local v0, "response":Lokhttp3/Response;
    .restart local v14    # "priorResponse":Lokhttp3/Response;
    ...
    .line 138
    .local v3, "requestSendStarted":Z
    :goto_116
    invoke-direct {v1, v0, v12, v3, v13}, Lokhttp3/internal/http/RetryAndFollowUpInterceptor;->recover(Ljava/io/IOException;Lokhttp3/internal/connection/StreamAllocation;ZLokhttp3/Request;)Z

    move-result v6
    :try_end_11a
    .catchall {:try_start_110 .. :try_end_11a} :catchall_10b
    ...
    .end local v3    # "requestSendStarted":Z
    :catch_125
    move-exception v0
    ...
    invoke-direct {v1, v3, v12, v6, v13}, Lokhttp3/internal/http/RetryAndFollowUpInterceptor;->recover(Ljava/io/IOException;Lokhttp3/internal/connection/StreamAllocation;ZLokhttp3/Request;)Z

    move-result v3
    :try_end_130
    .catchall {:try_start_124 .. :try_end_130} :catchall_10b
    ...
    invoke-virtual {v12, v5}, Lokhttp3/internal/connection/StreamAllocation;->streamFailed(Ljava/io/IOException;)V
    ...
    throw v3
    :try_end_145
    .catchall {:try_start_140 .. :try_end_145} :catchall_10b
    ...
    invoke-virtual {v12, v3}, Lokhttp3/internal/connection/StreamAllocation;->streamFailed(Ljava/io/IOException;)V
