...
public final class GoogleMapOptions extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public static LatLngBounds zza(Context context, AttributeSet attributeSet) {
        ...
        TypedArray typedArrayObtainAttributes = context.getResources().obtainAttributes(attributeSet, R.styleable.MapAttrs);
        if (typedArrayObtainAttributes.hasValue(R.styleable.MapAttrs_latLngBoundsSouthWestLatitude)) {
            fValueOf = Float.valueOf(typedArrayObtainAttributes.getFloat(R.styleable.MapAttrs_latLngBoundsSouthWestLatitude, 0.0f));
        } else {
            fValueOf = null;
        }
        if (typedArrayObtainAttributes.hasValue(R.styleable.MapAttrs_latLngBoundsSouthWestLongitude)) {
            fValueOf2 = Float.valueOf(typedArrayObtainAttributes.getFloat(R.styleable.MapAttrs_latLngBoundsSouthWestLongitude, 0.0f));
        } else {
            fValueOf2 = null;
        }
        if (typedArrayObtainAttributes.hasValue(R.styleable.MapAttrs_latLngBoundsNorthEastLatitude)) {
            fValueOf3 = Float.valueOf(typedArrayObtainAttributes.getFloat(R.styleable.MapAttrs_latLngBoundsNorthEastLatitude, 0.0f));
        } else {
            fValueOf3 = null;
        }
        if (typedArrayObtainAttributes.hasValue(R.styleable.MapAttrs_latLngBoundsNorthEastLongitude)) {
            fValueOf4 = Float.valueOf(typedArrayObtainAttributes.getFloat(R.styleable.MapAttrs_latLngBoundsNorthEastLongitude, 0.0f));
        } else {
            fValueOf4 = null;
        }
        typedArrayObtainAttributes.recycle();
    ...
    public static CameraPosition zzb(Context context, AttributeSet attributeSet) {
        ...
        if (typedArrayObtainAttributes.hasValue(R.styleable.MapAttrs_cameraTargetLng)) {
            f2 = typedArrayObtainAttributes.getFloat(R.styleable.MapAttrs_cameraTargetLng, 0.0f);
        } else {
            f2 = 0.0f;
        }
