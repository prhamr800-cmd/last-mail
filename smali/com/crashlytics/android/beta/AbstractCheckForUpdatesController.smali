###### Class com.crashlytics.android.beta.AbstractCheckForUpdatesController (com.crashlytics.android.beta.AbstractCheckForUpdatesController)
...
.method private performUpdateCheck()V
    ...
    iget-object v3, p0, Lcom/crashlytics/android/beta/AbstractCheckForUpdatesController;->buildProps:Lcom/crashlytics/android/beta/BuildProperties;

    invoke-virtual {v2, v0, v1, v3}, Lcom/crashlytics/android/beta/CheckForUpdatesRequest;->invoke(Ljava/lang/String;Ljava/lang/String;Lcom/crashlytics/android/beta/BuildProperties;)Lcom/crashlytics/android/beta/CheckForUpdatesResponse;
...
.method protected checkForUpdates()V
    ...
    monitor-exit v0
    :try_end_23
    .catchall {:try_start_3 .. :try_end_23} :catchall_ad
    ...
    .line 128
    .local v2, "updateCheckDelayMillis":J
    invoke-static {}, Lio/fabric/sdk/android/Fabric;->getLogger()Lio/fabric/sdk/android/Logger;
    ...
    .line 134
    .local v4, "nextCheckTimeMillis":J
    invoke-static {}, Lio/fabric/sdk/android/Fabric;->getLogger()Lio/fabric/sdk/android/Logger;
    ...
    .end local v2    # "updateCheckDelayMillis":J
    .end local v4    # "nextCheckTimeMillis":J
    :catchall_ad
    move-exception v1
