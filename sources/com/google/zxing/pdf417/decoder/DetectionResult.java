...
final class DetectionResult {
    ...
    DetectionResultColumn[] getDetectionResultColumns() {
        ...
        do {
            ...
            unadjustedCodewordCount = iAdjustRowNumbers;
            if (iAdjustRowNumbers <= 0) {
                break;
            }
        ...
        for (int codewordsRow = 0; codewordsRow < LRIcodewords.length; codewordsRow++) {
            if (LRIcodewords[codewordsRow] != null && RRIcodewords[codewordsRow] != null && LRIcodewords[codewordsRow].getRowNumber() == RRIcodewords[codewordsRow].getRowNumber()) {
                ...
                for (int barcodeColumn = 1; barcodeColumn <= this.barcodeColumnCount; barcodeColumn++) {
                    Codeword codeword3 = this.detectionResultColumns[barcodeColumn].getCodewords()[codewordsRow];
                    codeword2 = codeword3;
                    if (codeword3 != null) {
    ...
    private int adjustRowNumbersFromLRI() {
        ...
        for (int codewordsRow = 0; codewordsRow < codewords.length; codewordsRow++) {
            if (codewords[codewordsRow] != null) {
                ...
                for (int unadjustedCount2 = 1; unadjustedCount2 < this.barcodeColumnCount + 1 && invalidRowCounts < 2; unadjustedCount2++) {
                    Codeword codeword3 = this.detectionResultColumns[unadjustedCount2].getCodewords()[codewordsRow];
                    codeword2 = codeword3;
                    if (codeword3 != null) {
    ...
    public String toString() {
        ...
        Codeword codeword = null;
        int codewordsRow = 0;
        while (codewordsRow < rowIndicatorColumn.getCodewords().length) {
            ...
            for (int barcodeColumn = 0; barcodeColumn < this.barcodeColumnCount + 2; barcodeColumn++) {
                if (this.detectionResultColumns[barcodeColumn] == null) {
                    ...
                    if (codeword3 == null) {
                        ...
                        formatter.format(" %3d|%3d", Integer.valueOf(codeword2.getRowNumber()), Integer.valueOf(codeword2.getValue()));
                    }
                }
            }
