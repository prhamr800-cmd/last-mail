...
class DefaultSettingsJsonTransform implements SettingsJsonTransform {
    ...
    private PromptSettingsData buildPromptDataFrom(JSONObject json) throws JSONException {
        String title = json.optString(SettingsJsonConstants.PROMPT_TITLE_KEY, SettingsJsonConstants.PROMPT_TITLE_DEFAULT);
    ...
    private JSONObject toPromptJson(PromptSettingsData data) throws JSONException {
        return new JSONObject().put(SettingsJsonConstants.PROMPT_TITLE_KEY, data.title).put("message", data.message).put(SettingsJsonConstants.PROMPT_SEND_BUTTON_TITLE_KEY, data.sendButtonTitle).put(SettingsJsonConstants.PROMPT_SHOW_CANCEL_BUTTON_KEY, data.showCancelButton).put(SettingsJsonConstants.PROMPT_CANCEL_BUTTON_TITLE_KEY, data.cancelButtonTitle).put(SettingsJsonConstants.PROMPT_SHOW_ALWAYS_SEND_BUTTON_KEY, data.showAlwaysSendButton).put(SettingsJsonConstants.PROMPT_ALWAYS_SEND_BUTTON_TITLE_KEY, data.alwaysSendButtonTitle);
    }
}
