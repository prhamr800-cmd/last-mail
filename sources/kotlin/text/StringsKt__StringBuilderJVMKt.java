...
class StringsKt__StringBuilderJVMKt extends StringsKt__RegexExtensionsKt {
    ...
    @InlineOnly
    private static final Appendable appendln(@NotNull Appendable $receiver, CharSequence value) throws IOException {
        Appendable appendableAppend = $receiver.append(value);
        Intrinsics.checkExpressionValueIsNotNull(appendableAppend, "append(value)");
        return StringsKt.appendln(appendableAppend);
    }

    @InlineOnly
    private static final Appendable appendln(@NotNull Appendable $receiver, char value) throws IOException {
        Appendable appendableAppend = $receiver.append(value);
        Intrinsics.checkExpressionValueIsNotNull(appendableAppend, "append(value)");
        return StringsKt.appendln(appendableAppend);
    }
