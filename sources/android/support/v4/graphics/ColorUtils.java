...
public final class ColorUtils {
    ...
    public static int XYZToColor(@FloatRange(from = 0.0d, to = XYZ_WHITE_REFERENCE_X) double x, @FloatRange(from = 0.0d, to = XYZ_WHITE_REFERENCE_Y) double y, @FloatRange(from = 0.0d, to = XYZ_WHITE_REFERENCE_Z) double z) {
        ...
        return Color.rgb(constrain((int) Math.round((r > 0.0031308d ? (Math.pow(r, 0.4166666666666667d) * 1.055d) - 0.055d : r * 12.92d) * 255.0d), 0, 255), constrain((int) Math.round((g > 0.0031308d ? (Math.pow(g, 0.4166666666666667d) * 1.055d) - 0.055d : g * 12.92d) * 255.0d), 0, 255), constrain((int) Math.round(255.0d * (b > 0.0031308d ? (Math.pow(b, 0.4166666666666667d) * 1.055d) - 0.055d : 12.92d * b)), 0, 255));
    }
