...
interface zzzh {
    ...
    void zza(int i, zzun zzunVar) throws IOException;

    <K, V> void zza(int i, zzwx<K, V> zzwxVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzxu zzxuVar) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzxu zzxuVar) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzxu zzxuVar) throws IOException;
    ...
    @Deprecated
    void zzb(int i, List<?> list, zzxu zzxuVar) throws IOException;
