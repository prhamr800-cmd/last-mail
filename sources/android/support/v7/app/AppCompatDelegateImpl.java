...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    /* JADX WARN: Type inference failed for: r2v3, types: [android.view.Window] */
    ...
    private ViewGroup createSubDecor() {
        ...
        if (!this.mWindowNoTitle) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                ViewCompat.setOnApplyWindowInsetsListener(r52, new OnApplyWindowInsetsListener() { // from class: android.support.v7.app.AppCompatDelegateImpl.3
                ...
                ((FitWindowsViewGroup) r52).setOnFitSystemWindowsListener(new FitWindowsViewGroup.OnFitSystemWindowsListener() { // from class: android.support.v7.app.AppCompatDelegateImpl.4
    ...
    @Override // android.support.v7.app.AppCompatDelegate
    public boolean applyDayNight() throws IllegalAccessException {
    ...
    @Override // android.support.v7.app.AppCompatDelegate
    public void setLocalNightMode(int mode) throws IllegalAccessException {
        switch (mode) {
            case -1:
            case 0:
            case 1:
    ...
    private boolean updateForNightMode(int mode) throws IllegalAccessException {
    ...
    final class AutoNightModeManager {
        ...
        void dispatchTimeChanged() throws IllegalAccessException {
        ...
        void setup() {
            ...
            if (this.mAutoTimeChangeReceiver == null) {
                this.mAutoTimeChangeReceiver = new BroadcastReceiver() { // from class: android.support.v7.app.AppCompatDelegateImpl.AutoNightModeManager.1
                    ...
                    public void onReceive(Context context, Intent intent) throws IllegalAccessException {
