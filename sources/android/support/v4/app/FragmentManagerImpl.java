    ...
    */
    ...
    private void executeOpsTogether(ArrayList<BackStackRecord> records, ArrayList<Boolean> isRecordPop, int startIndex, int endIndex) {
        ...
        while (true) {
            ...
            if (!isPop) {
                fragmentTrackAddedFragmentsInPop = record.expandOps(this.mTmpAddedFragments, oldPrimaryNav2);
            } else {
                fragmentTrackAddedFragmentsInPop = record.trackAddedFragmentsInPop(this.mTmpAddedFragments, oldPrimaryNav2);
            }
            oldPrimaryNav2 = fragmentTrackAddedFragmentsInPop;
