...
public final class zzau extends zzfj {
    ...
    public zzau(zzfk zzfkVar) {
        super(zzfkVar);
        this.zzamx = Build.VERSION.SDK_INT < 19 ? new zzfv() : null;
    }
    ...
    protected final HttpURLConnection zzb(URL url) throws IOException {
        ...
        if (this.zzamx != null && (uRLConnectionOpenConnection instanceof HttpsURLConnection)) {
            ((HttpsURLConnection) uRLConnectionOpenConnection).setSSLSocketFactory(this.zzamx);
        }
