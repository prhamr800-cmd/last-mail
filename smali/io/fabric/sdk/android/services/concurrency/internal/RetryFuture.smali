###### Class io.fabric.sdk.android.services.concurrency.internal.RetryFuture (io.fabric.sdk.android.services.concurrency.internal.RetryFuture)
...
.method public run()V
    ...
    :try_end_1d
    .catch Ljava/lang/Throwable; {:try_start_14 .. :try_end_1d} :catch_25
    ...
    invoke-interface {v1, v3}, Lio/fabric/sdk/android/services/concurrency/internal/Backoff;->getDelayMillis(I)J

    move-result-wide v3

    .line 49
    .local v3, "delay":J
    iget-object v1, p0, Lio/fabric/sdk/android/services/concurrency/internal/RetryFuture;->retryState:Lio/fabric/sdk/android/services/concurrency/internal/RetryState;

    invoke-virtual {v1}, Lio/fabric/sdk/android/services/concurrency/internal/RetryState;->nextRetryState()Lio/fabric/sdk/android/services/concurrency/internal/RetryState;

    move-result-object v1

    iput-object v1, p0, Lio/fabric/sdk/android/services/concurrency/internal/RetryFuture;->retryState:Lio/fabric/sdk/android/services/concurrency/internal/RetryState;

    .line 50
    iget-object v1, p0, Lio/fabric/sdk/android/services/concurrency/internal/RetryFuture;->executor:Lio/fabric/sdk/android/services/concurrency/internal/RetryThreadPoolExecutor;

    sget-object v5, Ljava/util/concurrent/TimeUnit;->MILLISECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v1, p0, v3, v4, v5}, Lio/fabric/sdk/android/services/concurrency/internal/RetryThreadPoolExecutor;->schedule(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Ljava/util/concurrent/ScheduledFuture;
