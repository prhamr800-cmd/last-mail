...
public final class CameraPosition extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public final String toString() {
        return Objects.toStringHelper(this).add("target", this.target).add("zoom", Float.valueOf(this.zoom)).add("tilt", Float.valueOf(this.tilt)).add(Parameters.BEARING, Float.valueOf(this.bearing)).toString();
    }
