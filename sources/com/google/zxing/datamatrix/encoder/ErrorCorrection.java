    ...
    public static String encodeECC200(String codewords, SymbolInfo symbolInfo) {
        ...
        if (blockCount != 1) {
            ...
            for (int block = 0; block < blockCount; block++) {
                ...
                int pos = 0;
                int pos2 = block;
                while (pos2 < errorSizes[block] * blockCount) {
                    sb.setCharAt(symbolInfo.getDataCapacity() + pos2, ecc.charAt(pos));
                    pos2 += blockCount;
                    pos++;
                }
            }
