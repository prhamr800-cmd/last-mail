...
public final class BitArray implements Cloneable {
    ...
    public void toBytes(int bitOffset, byte[] array, int offset, int numBytes) {
        ...
        int bitOffset3 = 0;
        while (bitOffset3 < numBytes) {
            int theByte = 0;
            int theByte2 = bitOffset2;
            for (int bitOffset4 = 0; bitOffset4 < 8; bitOffset4++) {
                if (get(theByte2)) {
                    theByte |= 1 << (7 - bitOffset4);
                }
                theByte2++;
            }
            int j = offset + bitOffset3;
            array[j] = (byte) theByte;
            bitOffset3++;
            bitOffset2 = theByte2;
        }
    }
