...
public enum zzvr {
    ...
    zzvr(int i, zzvt zzvtVar, zzwg zzwgVar) {
        this.id = i;
        this.zzbyp = zzvtVar;
        this.zzbyo = zzwgVar;
        switch (zzvtVar) {
    ...
    static {
        zzvr[] zzvrVarArrValues = values();
        zzbys = new zzvr[zzvrVarArrValues.length];
        for (zzvr zzvrVar : zzvrVarArrValues) {
