...
public final class zzm extends AbstractSafeParcelable {
    ...
    zzm(@SafeParcelable.Param(id = 1) com.google.android.gms.location.zzj zzjVar, @SafeParcelable.Param(id = 2) List<ClientIdentity> list, @SafeParcelable.Param(id = 3) String str) {
        this.zzcf = zzjVar;
        this.zzm = list;
        this.tag = str;
    }
