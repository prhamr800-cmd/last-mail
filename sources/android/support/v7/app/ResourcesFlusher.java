...
class ResourcesFlusher {
    ...
    static void flush(@NonNull Resources resources) throws IllegalAccessException {
    ...
    @RequiresApi(23)
    private static void flushMarshmallows(@NonNull Resources resources) throws IllegalAccessException {
        if (!sDrawableCacheFieldFetched) {
            try {
                sDrawableCacheField = Resources.class.getDeclaredField("mDrawableCache");
                sDrawableCacheField.setAccessible(true);
    ...
    @RequiresApi(24)
    private static void flushNougats(@NonNull Resources resources) throws IllegalAccessException {
