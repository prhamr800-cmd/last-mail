###### Class io.realm.kotlin.RealmExtensionsKt (io.realm.kotlin.RealmExtensionsKt)
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "realm-kotlin-extensions_objectServerRelease"
    }
    k = 0x2
    mv = {
        0x1,
...
.method private static final createObject(Lio/realm/Realm;)Lio/realm/RealmModel;
    .registers 4
    .param p0, "$receiver"    # Lio/realm/Realm;
    ...
    invoke-virtual {p0, v1}, Lio/realm/Realm;->createObject(Ljava/lang/Class;)Lio/realm/RealmModel;

    move-result-object v1

    const-string/jumbo v2, "this.createObject(T::class.java)"
...
.method private static final createObject(Lio/realm/Realm;Ljava/lang/Object;)Lio/realm/RealmModel;
    ...
    invoke-virtual {p0, v1, p1}, Lio/realm/Realm;->createObject(Ljava/lang/Class;Ljava/lang/Object;)Lio/realm/RealmModel;

    move-result-object v1

    const-string/jumbo v2, "this.createObject(T::class.java, primaryKeyValue)"
...
.method private static final where(Lio/realm/Realm;)Lio/realm/RealmQuery;
    ...
    const-string/jumbo v2, "this.where(T::class.java)"
