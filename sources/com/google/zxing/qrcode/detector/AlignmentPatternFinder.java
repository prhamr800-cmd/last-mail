...
final class AlignmentPatternFinder {
    ...
    AlignmentPattern find() throws NotFoundException {
        ...
        for (int iGen = 0; iGen < height; iGen++) {
            ...
            AlignmentPattern confirmed = alignmentPattern;
            int currentState = 0;
            while (j < maxJ) {
                if (this.image.get(j, i)) {
                    if (currentState == 1) {
                        ...
                        if (foundPatternCross(stateCount)) {
                            AlignmentPattern alignmentPatternHandlePossibleCenter = handlePossibleCenter(stateCount, i, j);
                            confirmed = alignmentPatternHandlePossibleCenter;
                            if (alignmentPatternHandlePossibleCenter != null) {
                                return confirmed;
                            }
                        }
