...
public class MaterialDialog extends DialogBase implements View.OnClickListener, DefaultRvAdapter.InternalListCallback {
    ...
    public void setPromptCheckBoxChecked(boolean checked) {
        if (this.checkBoxPrompt != null) {
            this.checkBoxPrompt.setChecked(checked);
        }
    }
    ...
    private boolean sendMultiChoiceCallback() {
        ...
        return this.builder.listCallbackMultiChoice.onSelection(this, (Integer[]) this.selectedIndicesList.toArray(new Integer[this.selectedIndicesList.size()]), (CharSequence[]) selectedTitles.toArray(new CharSequence[selectedTitles.size()]));
    }
    ...
    public void setSelectedIndex(int index) {
        this.builder.selectedIndex = index;
    ...
    public static class Builder {
        ...
        public Builder(@NonNull Context context) {
            ...
            int fallback = Build.VERSION.SDK_INT >= 21 ? DialogUtils.resolveColor(context, android.R.attr.colorControlHighlight) : 0;
            ...
            int primaryTextColor = DialogUtils.resolveColor(context, android.R.attr.textColorPrimary);
        ...
        public Builder input(@StringRes int hint, @StringRes int prefill, boolean allowEmptyInput, @NonNull InputCallback callback) {
            CharSequence text = null;
            CharSequence text2 = hint == 0 ? null : this.context.getText(hint);
            if (prefill != 0) {
                text = this.context.getText(prefill);
            }
            return input(text2, text, allowEmptyInput, callback);
        }
