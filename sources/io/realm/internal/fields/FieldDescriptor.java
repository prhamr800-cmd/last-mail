...
public abstract class FieldDescriptor {
    ...
    static {
        ...
        SIMPLE_LINK_FIELD_TYPES = Collections.unmodifiableSet(s2);
        Set<RealmFieldType> s3 = new HashSet<>(1);
        s3.add(RealmFieldType.LIST);
        LIST_LINK_FIELD_TYPE = Collections.unmodifiableSet(s3);
        Set<RealmFieldType> s4 = new HashSet<>(1);
        s4.add(RealmFieldType.OBJECT);
        OBJECT_LINK_FIELD_TYPE = Collections.unmodifiableSet(s4);
    ...
    public static FieldDescriptor createFieldDescriptor(SchemaProxy schema, Table table, String fieldDescription, Set<RealmFieldType> validInternalColumnTypes, Set<RealmFieldType> validFinalColumnTypes) {
        ...
        if (schema == null || !schema.hasCache()) {
            dynamicFieldDescriptor = new DynamicFieldDescriptor(table, fieldDescription, validInternalColumnTypes != null ? validInternalColumnTypes : SIMPLE_LINK_FIELD_TYPES, validFinalColumnTypes);
        } else {
