...
public class ChipDrawable extends Drawable implements TintAwareDrawable, Drawable.Callback {
    ...
    public static ChipDrawable createFromResource(Context context, @XmlRes int id) {
        ...
        try {
            ...
            if (style == 0) {
                style = android.support.design.R.style.Widget_MaterialComponents_Chip_Entry;
            }
            return createFromAttributes(context, attrs, android.support.design.R.attr.chipStandaloneStyle, style);
    ...
    private void loadFromAttributes(AttributeSet attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(this.context, attrs, android.support.design.R.styleable.Chip, defStyleAttr, defStyleRes, new int[0]);
        setChipBackgroundColor(MaterialResources.getColorStateList(this.context, a, android.support.design.R.styleable.Chip_chipBackgroundColor));
        ...
        setChipStrokeColor(MaterialResources.getColorStateList(this.context, a, android.support.design.R.styleable.Chip_chipStrokeColor));
        setChipStrokeWidth(a.getDimension(android.support.design.R.styleable.Chip_chipStrokeWidth, 0.0f));
        setRippleColor(MaterialResources.getColorStateList(this.context, a, android.support.design.R.styleable.Chip_rippleColor));
        setText(a.getText(android.support.design.R.styleable.Chip_android_text));
        setTextAppearance(MaterialResources.getTextAppearance(this.context, a, android.support.design.R.styleable.Chip_android_textAppearance));
        int ellipsize = a.getInt(android.support.design.R.styleable.Chip_android_ellipsize, 0);
        switch (ellipsize) {
            case 1:
        ...
        setChipIcon(MaterialResources.getDrawable(this.context, a, android.support.design.R.styleable.Chip_chipIcon));
        setChipIconTint(MaterialResources.getColorStateList(this.context, a, android.support.design.R.styleable.Chip_chipIconTint));
        ...
        setCloseIcon(MaterialResources.getDrawable(this.context, a, android.support.design.R.styleable.Chip_closeIcon));
        setCloseIconTint(MaterialResources.getColorStateList(this.context, a, android.support.design.R.styleable.Chip_closeIconTint));
        ...
        setCheckedIcon(MaterialResources.getDrawable(this.context, a, android.support.design.R.styleable.Chip_checkedIcon));
        setShowMotionSpec(MotionSpec.createFromAttribute(this.context, a, android.support.design.R.styleable.Chip_showMotionSpec));
        setHideMotionSpec(MotionSpec.createFromAttribute(this.context, a, android.support.design.R.styleable.Chip_hideMotionSpec));
