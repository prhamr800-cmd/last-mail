...
public class GcmNetworkManager {
    ...
    private final boolean zze(String str) {
        ...
        List<ResolveInfo> listEmptyList = packageManager == null ? Collections.emptyList() : packageManager.queryIntentServices(str != null ? new Intent(GcmTaskService.SERVICE_ACTION_EXECUTE_TASK).setClassName(this.zzh, str) : new Intent(GcmTaskService.SERVICE_ACTION_EXECUTE_TASK).setPackage(this.zzh.getPackageName()), 0);
        if (CollectionUtils.isEmpty(listEmptyList)) {
            Log.e("GcmNetworkManager", String.valueOf(str).concat(" is not available. This may cause the task to be lost."));
            return true;
        }
        for (ResolveInfo resolveInfo : listEmptyList) {
    ...
    final synchronized boolean zzd(String str, String str2) {
        Map<String, Boolean> arrayMap = this.zzi.get(str2);
        if (arrayMap == null) {
            arrayMap = new ArrayMap<>();
            this.zzi.put(str2, arrayMap);
        }
