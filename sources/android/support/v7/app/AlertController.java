        ...
        private void createListView(final AlertController dialog) {
            ...
            if (this.mIsMultiChoice) {
                if (this.mCursor == null) {
                    listAdapter = new ArrayAdapter<CharSequence>(this.mContext, dialog.mMultiChoiceItemLayout, android.R.id.text1, this.mItems) { // from class: android.support.v7.app.AlertController.AlertParams.1
                ...
                adapter = this.mCursor != null ? new SimpleCursorAdapter(this.mContext, layout, this.mCursor, new String[]{this.mLabelColumn}, new int[]{android.R.id.text1}) : this.mAdapter != null ? this.mAdapter : new CheckedItemAdapter(this.mContext, layout, android.R.id.text1, this.mItems);
            }
