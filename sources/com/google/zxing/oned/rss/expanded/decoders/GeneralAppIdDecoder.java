    ...
    private DecodedInformation parseBlocks() throws FormatException {
        ...
        do {
            ...
            if (this.current.isAlpha()) {
                BlockParsedResult alphaBlock = parseAlphaBlock();
                result = alphaBlock;
                isFinished = alphaBlock.isFinished();
            } else if (this.current.isIsoIec646()) {
                BlockParsedResult isoIec646Block = parseIsoIec646Block();
                result = isoIec646Block;
                isFinished = isoIec646Block.isFinished();
            } else {
                BlockParsedResult numericBlock = parseNumericBlock();
                result = numericBlock;
                isFinished = numericBlock.isFinished();
            }
