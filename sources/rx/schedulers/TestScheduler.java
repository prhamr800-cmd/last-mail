...
public class TestScheduler extends Scheduler {
    ...
    private static class CompareActionsByTime implements Comparator<TimedAction> {
        ...
        public int compare(TimedAction action1, TimedAction action2) {
            return action1.time == action2.time ? Long.valueOf(action1.count).compareTo(Long.valueOf(action2.count)) : Long.valueOf(action1.time).compareTo(Long.valueOf(action2.time));
        }
    }
    ...
    private final class InnerTestScheduler extends Scheduler.Worker {
        ...
        public Subscription schedule(Action0 action, long delayTime, TimeUnit unit) {
            final TimedAction timedAction = new TimedAction(this, unit.toNanos(delayTime) + TestScheduler.this.time, action);
