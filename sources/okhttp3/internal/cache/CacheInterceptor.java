...
public final class CacheInterceptor implements Interceptor {
    ...
    static boolean isContentSpecificHeader(String fieldName) {
        return HttpRequest.HEADER_CONTENT_LENGTH.equalsIgnoreCase(fieldName) || HttpRequest.HEADER_CONTENT_ENCODING.equalsIgnoreCase(fieldName) || HttpRequest.HEADER_CONTENT_TYPE.equalsIgnoreCase(fieldName);
    }
}
