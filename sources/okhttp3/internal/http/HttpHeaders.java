...
public final class HttpHeaders {
                ...
                while (true) {
                    if (matcher.find(i)) {
                        ...
                        if (header.regionMatches(true, matcher.start(1), "realm", 0, 5)) {
                            ...
                            it = it2;
                            if (header.regionMatches(true, matcher.start(1), HttpRequest.PARAM_CHARSET, 0, 7)) {
    ...
    public static boolean hasBody(Response response) {
        ...
        return (((responseCode >= 100 && responseCode < 200) || responseCode == 204 || responseCode == 304) && contentLength(response) == -1 && !com.huxq17.download.utils.Util.TRANSFER_ENCODING_CHUNKED.equalsIgnoreCase(response.header("Transfer-Encoding"))) ? false : true;
    }
