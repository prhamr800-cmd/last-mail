...
public class MDTintHelper {
    ...
    public static void setTint(@NonNull RadioButton radioButton, @ColorInt int color) {
        ...
        ColorStateList sl = new ColorStateList(new int[][]{new int[]{android.R.attr.state_enabled, -16842912}, new int[]{android.R.attr.state_enabled, android.R.attr.state_checked}, new int[]{-16842910, -16842912}, new int[]{-16842910, android.R.attr.state_checked}}, new int[]{DialogUtils.resolveColor(radioButton.getContext(), R.attr.colorControlNormal), color, disabledColor, disabledColor});
    ...
    public static void setTint(@NonNull CheckBox box, @ColorInt int color) {
        ...
        ColorStateList sl = new ColorStateList(new int[][]{new int[]{android.R.attr.state_enabled, -16842912}, new int[]{android.R.attr.state_enabled, android.R.attr.state_checked}, new int[]{-16842910, -16842912}, new int[]{-16842910, android.R.attr.state_checked}}, new int[]{DialogUtils.resolveColor(box.getContext(), R.attr.colorControlNormal), color, disabledColor, disabledColor});
        setTint(box, sl);
    }
