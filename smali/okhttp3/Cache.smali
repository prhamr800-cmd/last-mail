...
.method get(Lokhttp3/Request;)Lokhttp3/Response;
    ...
    move-result-object v2
    :try_end_f
    .catch Ljava/io/IOException; {:try_start_9 .. :try_end_f} :catch_38
...
.method constructor <init>(Lokio/Source;)V
    ...
    invoke-virtual {v2, v6}, Lokhttp3/Headers$Builder;->addLenient(Ljava/lang/String;)Lokhttp3/Headers$Builder;
    ...
    .line 555
    iget-object v6, v5, Lokhttp3/internal/http/StatusLine;->message:Ljava/lang/String;

    iput-object v6, v1, Lokhttp3/Cache$Entry;->message:Ljava/lang/String;
    ...
    .line 557
    .local v6, "responseHeadersBuilder":Lokhttp3/Headers$Builder;
    invoke-static {v0}, Lokhttp3/Cache;->readInt(Lokio/BufferedSource;)I
    ...
    invoke-virtual {v6, v8}, Lokhttp3/Headers$Builder;->get(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v6, v9}, Lokhttp3/Headers$Builder;->removeAll(Ljava/lang/String;)Lokhttp3/Headers$Builder;
    ...
    :try_end_e4
    .catchall {:try_start_5 .. :try_end_e4} :catchall_e9
    ...
    .end local v5    # "statusLine":Lokhttp3/internal/http/StatusLine;
    .end local v6    # "responseHeadersBuilder":Lokhttp3/Headers$Builder;
...
.method private writeCertList(Lokio/BufferedSink;Ljava/util/List;)V
    ...
    :try_end_2e
    .catch Ljava/security/cert/CertificateEncodingException; {:try_start_0 .. :try_end_2e} :catch_33
