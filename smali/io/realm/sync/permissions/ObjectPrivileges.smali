###### Class io.realm.sync.permissions.ObjectPrivileges (io.realm.sync.permissions.ObjectPrivileges)
...
.method public equals(Ljava/lang/Object;)Z
    ...
    check-cast v2, Lio/realm/sync/permissions/ObjectPrivileges;

    .line 103
    .local v2, "that":Lio/realm/sync/permissions/ObjectPrivileges;
    iget-boolean v3, p0, Lio/realm/sync/permissions/ObjectPrivileges;->canRead:Z

    iget-boolean v4, v2, Lio/realm/sync/permissions/ObjectPrivileges;->canRead:Z
    ...
    .line 104
    :cond_1c
    iget-boolean v3, p0, Lio/realm/sync/permissions/ObjectPrivileges;->canUpdate:Z

    iget-boolean v4, v2, Lio/realm/sync/permissions/ObjectPrivileges;->canUpdate:Z
    ...
    .line 105
    :cond_23
    iget-boolean v3, p0, Lio/realm/sync/permissions/ObjectPrivileges;->canDelete:Z

    iget-boolean v4, v2, Lio/realm/sync/permissions/ObjectPrivileges;->canDelete:Z
    ...
    .line 106
    :cond_2a
    iget-boolean v3, p0, Lio/realm/sync/permissions/ObjectPrivileges;->canSetPermissions:Z

    iget-boolean v4, v2, Lio/realm/sync/permissions/ObjectPrivileges;->canSetPermissions:Z
    ...
    .line 107
    :cond_31
    iget-boolean v3, p0, Lio/realm/sync/permissions/ObjectPrivileges;->canQuery:Z

    iget-boolean v4, v2, Lio/realm/sync/permissions/ObjectPrivileges;->canQuery:Z
    ...
    .line 108
    :cond_38
    iget-boolean v3, p0, Lio/realm/sync/permissions/ObjectPrivileges;->canCreate:Z

    iget-boolean v4, v2, Lio/realm/sync/permissions/ObjectPrivileges;->canCreate:Z
    ...
    .line 109
    :cond_3f
    iget-boolean v3, p0, Lio/realm/sync/permissions/ObjectPrivileges;->canModifySchema:Z

    iget-boolean v4, v2, Lio/realm/sync/permissions/ObjectPrivileges;->canModifySchema:Z
    ...
    .line 99
    .end local v2    # "that":Lio/realm/sync/permissions/ObjectPrivileges;
    :cond_48
    :goto_48
    return v1
.end method
