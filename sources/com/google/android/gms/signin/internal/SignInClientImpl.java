    ...
    public final void zaa(zad zadVar) {
        ...
        try {
            ...
            if ("<<default account>>".equals(accountOrDefault.name)) {
                savedDefaultGoogleSignInAccount = Storage.getInstance(getContext()).getSavedDefaultGoogleSignInAccount();
            }
            ((zaf) getService()).zaa(new zah(new ResolveAccountRequest(accountOrDefault, this.zaod.intValue(), savedDefaultGoogleSignInAccount)), zadVar);
        } catch (RemoteException e) {
